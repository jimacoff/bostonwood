          ...
          var rowPriceFunction = function(inputArray) {
            for(n = 0; n < inputArray.length; n++) {
              ...
              if (n === inputArray.length - 1) {
                priceRowStart = priceRowStart + "<td class='first-td last'></td><td class='height-dim'><b>" + heights[n] + "\"</b></td>";
              } else {
                priceRowStart = priceRowStart + "<td class='first-td'></td><td class='height-dim'><b>" + heights[n] + "\"</b></td>";
              }
